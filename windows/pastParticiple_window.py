...
class pastParticiple_window(QWidget):
    question_counter = 0
    answer_array = []
    def __init__(self):
        super().__init__()
    ...
    def initUI(self):
        self.setWindowTitle("Past Participle")
        ...
        self.QuestionEnL.setText(Questions_past_participle[Random_index[self.question_counter]].english)
        ...
        self.QuestionRusL.setText(Questions_past_participle[Random_index[self.question_counter]].russian)
    ...
    def next(self):
        if self.line.text() == Questions_past_participle[Random_index[self.question_counter]].answer:
            Array.append(Answer(Questions_past_participle[Random_index[self.question_counter]].english,Questions_past_participle[Random_index[self.question_counter]].answer, True))
        else:
            Array.append(Answer(Questions_past_participle[Random_index[self.question_counter]].english,Questions_past_participle[Random_index[self.question_counter]].answer, False))
