...
class infinitive_window(QWidget):
    ...
    def next(self):
        if self.line.text() == Questions_inf[Random_index[self.question_counter]].answer:
            Array.append(Answer(Questions_inf[Random_index[self.question_counter]].english,Questions_inf[Random_index[self.question_counter]].answer, True))
        else:
            Array.append(Answer(Questions_inf[Random_index[self.question_counter]].english,Questions_inf[Random_index[self.question_counter]].answer, False))
